...
export default function About({ active }) {
  return (
    ...
    >
      <Reveal className="max-w-7xl w-full grid grid-cols-1 md:grid-cols-12 gap-16 px-8 md:px-32 items-center">
        <div className="md:col-span-5 relative">
          ...
          <div className="absolute -bottom-8 -right-8 bg-secondary text-surface p-8 hidden md:block shadow-[0_0_20px_rgba(60,215,255,0.4)]">
        ...
        <div className="md:col-span-7 space-y-10">
          ...
          <blockquote className="font-display text-4xl md:text-5xl italic font-light text-primary border-l-4 border-secondary pl-8 py-2">
