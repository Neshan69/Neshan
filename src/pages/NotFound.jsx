    ...
    <>
      <div className="min-h-screen bg-surface flex items-center justify-center p-6">
        <div className="max-w-md w-full text-center">
          ...
          <a href="/" className="inline-block bg-secondary text-surface px-8 py-3 rounded-xl font-bold text-xs tracking-widest hover:brightness-110 transition-all">GO HOME</a>
        </div>
      </div>
