...
export default function ProjectCard({ project }) {
  return (
    <article
      className={`min-w-[220px] md:min-w-[280px] snap-start cursor-default`}
    >
      <div className="relative overflow-hidden aspect-[16/10] bg-outline-variant/30 border border-white/5">
        <SmartImage
          className="w-full h-full object-cover grayscale brightness-75 hover:grayscale-0 hover:brightness-100 transition-all duration-300 hover:scale-105"
          src={project.src}
